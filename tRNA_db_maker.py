...
def RuntRNAScan(wdir, tRNAscanSE, trna_fasta, out_file):
    """A warpper function to run RNA Scan program

    Args:
        wdir (String): The path of work directory
        tRNAscanSE (String): The path of tRNAscan
        trna_fasta (String): A FASTA file of tRNA genes with UTR generated by CreatetRNAFastas
        out_file (String): A tab file about tRNA gene structure

    Returns:
        int: if 0 means no error happen or others
    """
    try:
...
# Function to generate tRNA datanbase for following tRNAExplorer analysis
